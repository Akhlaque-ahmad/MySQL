...
/*country_nulls,worlwide_gross_income_nulls,languages_nulls,production_company_nulls have null values*/
...
-- got movie FAN in the top 10 movies with an average rating of 9.6
...
INNER JOIN ratings AS r
ON m.id = r.movie_id
WHERE median_ratig = 8 AND date_published BETWEEN '2018-04-01' AND '2019-04-01'
GROUP BY median_rating;
...
-- got favourite actor 'Mohanlal' as 2nd in the list
...
(
 ...
 (
	 SELECT d.name_id AS director_id,
		 ...
		 MIN(avg_rating) AS min_rating,SUM(duration) AS total_duration,
